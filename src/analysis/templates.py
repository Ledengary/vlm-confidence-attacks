...
def ladder_full_footnote(wb_excl, wb_bitexact, wb_min, wb_max):
    return (
        r"\vspace{3pt}"
        + "\n"
        + r"\noindent{\footnotesize All AUROC are worst-case-oracle attacked verifier confidence. ``mean, excl.\ under-powered white-box'' drops the one under-powered Molmo-verifier white-box pair (Gemma$\to$Molmo), giving a white-box mean of "
        + wb_excl
